...
### Componentes do labirinto:
  ...
  - <b>🌀 Portais:</b>
    - ***as extremidades da esquerda (círculo laranja) e direita (círculo azul) funcionam como "portais"***;
...
O código contém algumas funções principais:
  ...
  - Depois, a função <code>readCheckpoint</code> é responsável por ler as informações salvas no último arquivo de checkpoint criado para a matriz.
